    ...
    <div class="container col-xl-10 col-xxl-8 px-4 py-5">
            ...
            <div class="row p-4 pb-0 pe-lg-0 pt-lg-5 align-items-center rounded-3 border shadow-lg">
                <div class="col-lg-7 p-3 p-lg-5 pt-lg-3">
                    ...
                    <p class="lead">
                        ...
                        Most importantly, feeds are always loaded fresh so you can stay up to date.
                    </p>
        ...
        <div class="row featurette">
            <div class="col-md-7 order-md-2">
                <h2 class="featurette-heading">Follow your passion. <span class="text-muted">And never miss news.</span></h2>
                <p class="lead">ownportal lets you add highlights so that most important keywords are clearly visible while you scroll the sea of news. Highlights give you even more - notifications! With notifications any matching news end up in your Notification folder so you can easily access the news that interest you the most. You can read your favourite feeds in light or dark mode, as well as show only news titles or full descriptions. Registering is simple and requires only your email and password. In other words, we value your privacy.</p>
            </div>
            <div class="col-md-5 order-md-1">
                <img class="rounded-lg-3" src="../assets/dark.png" alt="" width="500">
            </div>
        </div>
        ...
        <div class="px-4 py-5 text-center">
            ...
            <h1 class="display-5 fw-bold">Your own personal space</h1>
            ...
            <p class="lead mb-4">
                ...
                This is a one person's hobby project. You will encounter some rough edges while using ownportal, but you can
